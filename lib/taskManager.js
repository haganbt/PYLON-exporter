...
/**
 * _addFilter - adds a master filter 
 * and the config filter property for each task
 ...
 * @private
 */
var _addFilter = function _addFilter(reqParams, eachTask) {
